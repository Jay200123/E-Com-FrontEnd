...
export default function () {
  return (
    <form className="flex items-center w-full h-[32rem] rounded-sm shadow-md">
      ...
      <div className="flex flex-col w-1/2 h-full p-4">
        ...
        <p className="mb-4 text-[1rem] text-gray-600">Already have an account?<span className="ml-1 font-bold underline">Sign In</span></p>
        <input
          type="text"
